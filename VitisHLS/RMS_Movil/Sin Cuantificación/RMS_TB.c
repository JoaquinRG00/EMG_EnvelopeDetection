...
#include "stdio.h"
#include "RMS.h" // Se declara el archivo que se va a simular. RNC: Sí, pero lo tienes que crear, porque sólo así no funciona.
#include <math.h>
...
float in_real[] = {
	#include "Datain_RMS.txt"
};

float out_gold[] = {
	#include "Dataout_RMS.txt"
};
...
int main(void)
{
	...
	// 3- Ahora contratamos lo que nos ha salido del algoritmo en C con lo que sale en Matlab. En este caso de forma visual
