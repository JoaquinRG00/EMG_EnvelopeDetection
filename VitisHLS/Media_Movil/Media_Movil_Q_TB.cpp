//Test Bench de la Media Movil
//Código de la Media Movil con Ap_fixed (los datos estan cuantizados)
//Joaquín Ramos García

#include <iostream>   // cout
#include "Media_Movil_Q.hpp" // Se declara el archivo que se va a simular. RNC: Sí, pero lo tienes que crear, porque sólo así no funciona.
#include <cmath>
#include <fstream>
...
int main(void)
{
    std::ifstream fileInput("Datain_MM_Q.dat", std::ios::binary);
    std::ifstream fileOutput("Dataout_MM_Q.dat", std::ios::binary);
